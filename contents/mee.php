...
<body>
<form action="../assets/php/mee_update.php" method="POST" id="form" enctype="multipart/form-data">
        ...
        <div class="timetable hidden animate__animated animate__slower" id="timetable">
            ...
            <div class="timetablecontent">
                ...
                <div id="downloadwrapper">
                    ...
                    <button class="download"><a href="../assets/files/MEE Time-Table for the Semester.docx" download="Time-Table for the Semester">Download File</a></button>
                </div>
