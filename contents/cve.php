...
<body>
<form action="../assets/php/cve_update.php" method="POST" id="form" enctype="multipart/form-data">
        ...
        <div class="timetable hidden animate__animated animate__slower" id="timetable">
            ...
            <div class="timetablecontent">
                ...
                <div id="downloadwrapper">
                    ...
                    <button class="download"><a href="../assets/files/CVE Time-Table for the Semester.docx" download="Time-Table for the Semester">Download File</a></button>
                </div>
