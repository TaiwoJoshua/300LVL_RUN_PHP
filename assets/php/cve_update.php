...
<?php
    ...
    if(isset($_POST['usubmit'])){
        ...
        if(password_verify($upass, $password)){
            ...
            $trun = "TRUNCATE cve_announcement";
            ...
            for($i=0; $i < $n_announce; $i++){
                if($_POST['announce'][$i] == ""){
                    ...
                    $aupdate = "INSERT INTO cve_announcement VALUES(null,'$aannounced', '$DateTime')";
            ...
            for($i=0; $i < $nrow; $i++){
                ...
                $tupdate = "UPDATE cve_timetable SET `Period 1`='$period1',`Period 2`='$period2',`Period 3`='$period3',`Period 4`='$period4',`Period 5`='$period5',`Period 6`='$period6',`Period 7`='$period7',`Period 8`='$period8',`Period 9`='$period9',`Period 10`='$period10' WHERE id=($i+1)";
            ...
            for($i=0; $i < $ncourse; $i++){
                ...
                $units = $_POST['units'][$i];
                $cupdate = "UPDATE cve_courses SET `course_code`='$courseCode',`course_title`='$courseTitle',`units`='$units' WHERE id=($i+1)";
            ...
            }elseif($filename == "CVE Time-Table for the Semester.docx" || $filename == "CVE Time-Table for the Semester.doc"){
            ...
            header('refresh: 7; ../../contents/cve.php');
        }else{
